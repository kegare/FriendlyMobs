...
package com.kegare.friendlymobs.client.gui;
...
import com.kegare.friendlymobs.api.event.GuiSelectedEvent.PostMobSelectedEvent;
...
public class GuiSelectMob extends GuiScreen
{
	...
	public void drawScreen(int mouseX, int mouseY, float ticks)
	{
		...
		drawCenteredString(fontRendererObj, I18n.format(FriendlyMobs.CONFIG_LANG + "select.mob"), width / 2, 15, 0xFFFFFF);
		...
		if (!mobList.selected.isEmpty())
		{
			...
			{
				drawString(fontRendererObj, I18n.format(FriendlyMobs.CONFIG_LANG + "select.mob.selected", selected.size()), 5, 5, 0xEFEFEF);
			}

...
public class Version extends RecursiveAction
{
	...
	public static void versionCheck()
	{
		...
		FriendlyUtils.getPool().execute(new Version());
	}
	...
	protected void compute()
	{
		try
		{
			URL url = new URL(FriendlyMobs.metadata.updateUrl);
			...
			{
				FriendlyMobs.metadata.url = (String)data.get("homepage");
			}
		...
		{
			FriendlyLog.log(Level.WARN, e, "An error occurred trying to version check");
